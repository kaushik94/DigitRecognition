package view 
{
	...
	public class DrawingSpace extends Sprite 
	{
		...
		private function onTimerComplete(e:TimerEvent):void 
		{
			...
			var scale:Number = desiredWidth/stage.stageWidth;
		...
		private function showDigit(e:DataEvent):void 
		{
			...
			timeLine.append(TweenLite.to(this, 0.3, { alpha:0 , onComplete: removeLines } ));
			timeLine.append(TweenLite.to(digit, 0.5, { alpha:1, onComplete:addListeners } ));
